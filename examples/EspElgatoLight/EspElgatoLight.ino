/*
 * Control an Elgato Light Air.
 * See https://github.com/NickParks/elgato-light-api
 * $ cat elgato-on
 * curl -X PUT http://192.168.1.96:9123/elgato/lights -d '{"numberOfLights":1,"lights":[{"on":1}]}'
 * $ cat elgato-off 
 * curl -X PUT http://192.168.1.96:9123/elgato/lights -d '{"numberOfLights":1,"lights":[{"on":0}]}'
 *
